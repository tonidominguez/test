...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().waterGoal = FFAppState().waterGoal;
      safeSetState(() {});
      ...
      safeSetState(() {});
      // checkUserInfo
      await action_blocks.checkUserInfo(context);
    });
                          ...
                          Padding(
                            ...
                            child: Semantics(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed(WaterWidget.routeName);
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                    color:
                                ...
                                child: Padding(
                                  ...
                                  child: Semantics(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context
                                            .pushNamed(MealsWidget.routeName);
                                      },
                                      child: Container(
                                        height: 120.0,
                                        decoration: BoxDecoration(
                                          color: Color(0xFFDEDE1C),
                                          boxShadow: [
                                            BoxShadow(
                                              blurRadius: 4.0,
                                              color: Color(0x34090F13),
