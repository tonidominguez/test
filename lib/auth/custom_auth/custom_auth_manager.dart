...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    retoBariatricoSQLAuthUserSubject.add(
      RetoBariatricoSQLAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RetoBariatricoSQLAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RetoBariatricoSQLAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RetoBariatricoSQLAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    retoBariatricoSQLAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
RetoBariatricoSQLAuthUser? currentUser;
